...
import { Form, Input, Select, Button, Space, Spin, Alert, message, Row, Col } from 'antd';
import {
  ArrowLeftOutlined,
  UserOutlined,
  IdcardOutlined,
  ...
  if (!user) {
    return (
      <>
        ...
        <Alert message="Error" description="User not found" type="error" showIcon />
      </>
    );
  }
  ...
  return (
    <>
      ...
      <div style={{ marginBottom: 24 }}>
        <span style={{ fontSize: 20, fontWeight: 700, color: 'var(--text-primary)' }}>Edit User</span>
      </div>
